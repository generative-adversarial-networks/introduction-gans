...
#     real_data = get_real_data(d_minibatch_size,d_input_size)
...
#     noise = read_latent_space(d_minibatch_size, g_input_size)
#     fake_data = G( noise )
...
#
#     if epoch % 500 == 0:
#         plot_data(generated, real_data_mean, real_data_stddev)
#
